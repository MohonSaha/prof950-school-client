...
//       <div className="bg-gray-850 py-6 border-t border-b border-gray-800">
...
//                 alt="MohonSaha"
//                 className="h-16 w-16 rounded-full object-cover border-2 border-blue-500 mr-4"
//               />
//               <div>
//                 <h4 className="font-bold text-lg">MohonSaha</h4>
//                 <p className="text-blue-400">Web Software Developer</p>
//               </div>
//             </div>
//             <div className="flex space-x-4">
//               <a
...
//               © {currentYear} Excellence Academy. All rights reserved. Designed
//               & Developed by{" "}
//               <a
//                 href="https://mohonsaha.dev"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-center">
            <div className="text-center mb-6 w-full">
              <h4 className="text-xl font-bold text-white mb-1">Powered by</h4>
              {/* <div className="flex items-center justify-center">
                <img
                  src="https://i.ibb.co.com/0y7dTGF7/479983132-952578247065153-8801647807934248155-n.jpg"
                  alt="Prod950 Logo"
                  className="h-10 mr-2 rounded-ful"
                />
              </div> */}
