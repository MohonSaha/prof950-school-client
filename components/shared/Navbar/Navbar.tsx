...
//                 key={item.name} 
//                 href={item.href}
//                 className={`relative px-3 py-2 text-green-600 font-medium transition-colors duration-300 ease-in-out hover:text-green-700 ${
...
//         <a
//           ref={ref}
//           className={`block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground ${className} relative`}
//           {...props}
//         >
//           <div className="text-sm font-medium leading-none">{title}</div>
//           <p className="text-sm leading-snug text-muted-foreground">
...
//           </p>
//           {isActive && (
//             <span className="absolute bottom-0 left-0 w-full h-0.5 bg-green-600 transition-all duration-300 ease-in-out" />
//           )}
//         </a>
//       </NavigationMenuLink>
//     </li>
